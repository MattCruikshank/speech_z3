    ...
    main: for(;;) {
      ...
      switch(inst) {
        ...
        case 134: // DEC
          ...
          break;
        case 135: // PRINTB
          this.genPrint(this.getText(op0&65535));
          break;
        case 137: // REMOVE
          move(op0,0);
          break;
        case 138: // PRINTD
          this.genPrint(this.getText(this.getu(objects+op0*9+7)+1));
          break;
        case 139: // RETURN
          ret(op0);
          break;
        case 140: // JUMP
          ...
          break;
        case 141: // PRINT
          this.genPrint(this.getText(addr(op0)));
          break;
        case 142: // VALUE
          store(xfetch(op0));
          break;
        ...
        case 181: // SAVE
          ...
          predicate(await this.save(this.serialize(ds,cs,pc)));
          break;
        case 182: // RESTORE
          this.savedFlags=this.get(16);
          if(z=await this.restore()) z=this.deserialize(z);
          this.put(16,this.savedFlags);
        ...
        case 228: // READ
          this.genPrint("");
          if(this.updateStatusLine) this.updateStatusLine(this.getText(this.getu(objects+xfetch(16)*9+7)+1),xfetch(18),xfetch(17));
          this.handleInput(await this.read(mem[op0&65535]),op0&65535,op1&65535);
          break;
        case 229: // PRINTC
          this.genPrint(op0==13?"\n":op0?String.fromCharCode(op0):"");
          break;
        case 230: // PRINTN
          this.genPrint(String(op0));
          break;
        case 231: // RANDOM
